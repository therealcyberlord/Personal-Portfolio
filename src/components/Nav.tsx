    ...
    <header className={`fixed w-full top-0 z-50 transition-all duration-300 ${
      ...
      <nav className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          <Link 
            to="/" 
            className="text-white font-bold text-2xl md:text-3xl flex items-center gap-2 hover:text-sky-400 transition-all duration-300 transform hover:scale-105 tracking-tighter"
          >
            <span>Xingyu</span>
          ...
          <ul className="flex items-center space-x-1 sm:space-x-2">
            ...
            <li className="ml-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-sky-600 text-white rounded-lg hover:bg-sky-700 transition-all duration-300 transform hover:scale-105 hover:shadow-lg font-medium"
              >
